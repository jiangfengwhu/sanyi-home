...
export function meta() {
  return [
    { title: "JiangFeng - Frontend Developer | 前端开发者" },
    {
      name: "description",
      content:
        "前端开发者 JiangFeng 的个人主页，曾就职于小米、快手，专注于创建优雅且高效的用户界面。Portfolio of JiangFeng, a frontend developer formerly at Xiaomi and Kuaishou.",
    },
    {
      name: "keywords",
      content:
        "JiangFeng,前端开发,Frontend Developer,React,React Native,Swift,Golang,TypeScript,Node.js",
    },
    { property: "og:title", content: "JiangFeng - Frontend Developer" },
    {
